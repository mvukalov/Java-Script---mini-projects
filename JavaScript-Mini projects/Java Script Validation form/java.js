...
function checkpassword(password){
    if(password.length>7 && password.includes('.'))
    {
     ...
     document.getElementById('password_error').innerHTML=''
        ...
        document.getElementById('password_error').innerText='pasword is not long enough and most contain dot'
    }
    }

    function checkcpassword(password,cpassword){
  if(cpassword==password && cpassword.length>7){
    ...
    document.getElementById('cpassword_error').innerText='pasword doesnt match'
